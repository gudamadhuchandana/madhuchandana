...
import cv2
import os
labelsPath='/home/colour-detection/maduchandana/yolo-coco/coco.names'
LABELS = open(labelsPath).read().strip().split("\n")
np.random.seed(42)
COLORS = np.random.randint(0, 255, size=(len(LABELS), 3),
	dtype="uint8")
weightsPath='/home/colour-detection/maduchandana/yolo-coco/yolov3.weights'
